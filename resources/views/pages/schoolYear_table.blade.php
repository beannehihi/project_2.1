            ...
            <div class="row">
                <div class="col-12">
                    <div class="input-group w-30">
                        <div class="px-4">
                            <button type="button" class="btn shadow border border-2" data-mdb-toggle="modal"
                                data-mdb-target="#exampleModal">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                            </button>
                        </div>

                        <form action="{{ route('school_years') }}" method="GET">
                            <div class="d-flex">
                                        ...
                                        @foreach ($schoolYears as $schoolYear)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary  text-xs font-weight-bold">{{ \Carbon\Carbon::parse($schoolYear->created_at)->format('d/m/Y') }}</span>
                                                </td>
                                            </tr>
